    ...
    <span class="d-flex">
        ...
        if (!str_ends_with($current_path, 'login.php')) {
            ...
            if (isset($_SESSION["email"])) {
                ...
                </svg><span class="ms-1 link-text fs-5 fw-light">ACCOUNT</span>';
            } else {
                ...
                </svg><span class="ms-1 link-text fs-5 fw-light">LOGIN</span>';
            }
            echo '</a>';
        }
        ?>
        <?php  echo '<div class="dropdown">
                <span class="p-2 ms-3 me-2 d-flex align-items-center dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ACCOUNT
                </span>
